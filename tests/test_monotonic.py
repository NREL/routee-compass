...
class TestMonotonic(TestCase):
    def test_monotonic(self):
        self.run_test("osm_default_energy.toml", "2017_CHEVROLET_Bolt", "edge_energy_electric")

    def run_test(self, config_filename: str, model_name: str, energy_key: str):
        config_dir = Path(HERE) / ".." / "python" / "nrel" / "routee" / "compass" / "resources" / "downtown_denver_example"
