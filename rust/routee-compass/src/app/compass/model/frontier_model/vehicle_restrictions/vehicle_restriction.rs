...
pub enum VehicleRestriction {
    MaximumTotalWeight { value: Weight, unit: WeightUnit },
    MaximumWeightPerAxle { value: Weight, unit: WeightUnit },
    MaximumLength { value: Distance, unit: DistanceUnit },
    MaximumWidth { value: Distance, unit: DistanceUnit },
    MaximumHeight { value: Distance, unit: DistanceUnit },
    MaximumTrailerLength { value: Distance, unit: DistanceUnit },
}
...
impl VehicleRestriction {
    ...
    pub fn valid(
        ...
        let result = match self {
            VehicleRestriction::MaximumTotalWeight { value, unit } => {
            ...
            VehicleRestriction::MaximumWeightPerAxle { value, unit } => {
                let (vehicle_weight, weight_unit) = vehicle_parameters.total_weight;
                let mut weight_in_restriction_unit = Cow::Owned(vehicle_weight);
                weight_unit.convert(&mut weight_in_restriction_unit, restriction_unit)?;
            ...
            VehicleRestriction::MaximumLength { value, unit } => {
            ...
            VehicleRestriction::MaximumWidth { value, unit } => {
            ...
            VehicleRestriction::MaximumHeight { value, unit } => {
            ...
            VehicleRestriction::MaximumTrailerLength { value, unit } => {
