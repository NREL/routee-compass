...
use super::{
    vehicle_restriction_model::VehicleRestrictionFilterModel, VehicleParameter,
...
impl FilterModelService for VehicleRestrictionFrontierService {
    fn build(
        &self,
        ...
        let vehicle_parameters: Vec<VehicleParameter> = vehicle_parameter_configs
            ...
            .map(|vpc| vpc.into())
            .collect();
        let model = VehicleRestrictionFilterModel {
            service,
            vehicle_parameters,
        };
