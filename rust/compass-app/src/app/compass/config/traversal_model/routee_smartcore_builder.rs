...
pub struct RouteESmartcoreBuilder {}

pub struct RouteESmartcoreService {
    m: Arc<RouteERandomForestModel>,
}

impl TraversalModelBuilder for RouteESmartcoreBuilder {
    fn build(
        &self,
        ...
        let service = RouteESmartcoreService { m: Arc::new(m) };
        return Ok(Arc::new(service));
    }
}

impl TraversalModelService for RouteESmartcoreService {
    fn build(
        &self,
