...
use compass_core::model::termination::termination_model::TerminationModel;
use compass_core::util::conversion::duration_extension::DurationExtension;
use log;
...
impl TerminationModelBuilder {
    ...
    pub fn build(
        ...
        use compass_core::model::termination::termination_model::TerminationModel as T;
        let term_type_obj =
            config
                .get("type")
