...
def generate_compass_dataset(
    ...
    :type agg: Callable
    :param default_config: if true, copy default configuration files into the output directory
    :type default_config: bool
    :param default_energy_model: if true, copy a trained RouteE Powertrain model into the output directory
    ...
    if default_config:
        ...
        for filename in ['osm_default_distance.toml', 'osm_default_speed.toml', 'osm_default_energy.toml']:
